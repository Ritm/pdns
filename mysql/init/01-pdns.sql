CREATE DATABASE IF NOT EXISTS pdnsadmin CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
GRANT ALL PRIVILEGES ON pdnsadmin.* TO 'pdns'@'%';
...
CREATE INDEX IF NOT EXISTS ordername_idx ON records(ordername);
